...
## Added gem
# A simple facade for managing the relationship between your model and API. (https://github.com/ruby-grape/grape-entity)
gem 'grape-entity'
...
## Added gem
# A Ruby Library for dealing with money and currency conversion. (https://rubymoney.github.io/money)
# gem 'money'
